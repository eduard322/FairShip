...
class SiFeCaloPoint : public FairMCPoint
{
  ...
  private:
    ...
    SiFeCaloPoint(const SiFeCaloPoint& point);
    SiFeCaloPoint operator=(const SiFeCaloPoint& point);

    ClassDef(SiFeCaloPoint, 1)
};
